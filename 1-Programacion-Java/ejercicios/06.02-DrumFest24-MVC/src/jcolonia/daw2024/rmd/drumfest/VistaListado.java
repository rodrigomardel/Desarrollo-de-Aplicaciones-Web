...
public class VistaListado extends VistaGeneral {
	...
	public void acercaDe() {
		out.printf(
				"%s © DrumFest'24 v1.0 %n Aplicación para el registro y gestión de las bandas que conforman el nuevo festival de las/os %n mejores bateristas en el panorama nacional e internacional. %n Rodrigo Martínez Delgado - CIFP Juan de Colonia - rodrigo.mardel@educa.jcyl.es - 20240421 %s %n",
				CYAN, RESET);
	}
