...
/**
 * Sujeto que interactúa saludando al resto de personajes, contabilizando el
 * número de frases.
 */
public class Personaje extends Actor implements Cotizable {
	...
	public String despide() {
		String texto;
		anotaFrase();
		texto = String.format("%s se " + "despide [%d]", getNombre(), númFrases);
		return texto;
	...
	public DatosNómina getDatos() {
		...
		datos = new DatosNómina(id, nombre, cantidad, coeficiente);
		return datos;
	}
