...
public class Conjunto4D {
	 ...
	 * Lista de Grupos4D.
	 */
	private ArrayList<Grupo4DMejorado> lista;
	...
	public Conjunto4D(int capacidad) throws Grupo4DException {
		...
		lista = new ArrayList<Grupo4DMejorado>(capacidad);
...
//		}
	 ...
	 */
	public void añadirElemento(Grupo4DMejorado elementoNuevo) throws Grupo4DException {
...
//		}
	...
	public void ordenar() {
		...
		lista.sort((Grupo4DMejorado g1, Grupo4DMejorado g2) -> g1.compareTo(g2));
	}
