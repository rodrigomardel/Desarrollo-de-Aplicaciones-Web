...
/**
 * Ampliación de las prubeas realizadas en {@link Grupo4DTest} usando la clase
 * {@link Grupo4DMejorado}. Comprobaciones básicas de los valores inicializados
 * en el constructor predeterminado, constructor con valores, modificaciones y
 * consulta de esos valores.
 * 
 * @author Rodrigo Martínez Delgado &lt;rodrigo.mardel@educa.jcyl.es&gt;
 * @version 1.0 (20240201)
 */
class Grupo4DMejoradoVerdeTest {

	/** Cuarto conjunto de cuatro números decimales. */
	private Grupo4DMejorado grupo4;
	 ...
	 * 
	 * @see Grupo4DMejorado#Grupo4DMejorado(double, double, double, double)
	 */
	@Test
	...
	void testSetGetA1() {
		...
		grupo1 = new Grupo4DMejorado(a, b, c, d);
		grupo1.setA(nuevo);
	...
	void testSetGetB1() {
		...
		grupo2 = new Grupo4DMejorado(a, b, c, d);
		grupo2.setB(nuevo);
	...
	void testSetGetC1() {
		...
		grupo3 = new Grupo4DMejorado(a, b, c, d);
		grupo3.setC(nuevo);
